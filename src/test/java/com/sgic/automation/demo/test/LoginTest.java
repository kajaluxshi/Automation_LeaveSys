...
//            .click();
        ...
        driver.findElement(By.xpath(
          "/html/body/app-root/app-login/div/div/div/div/div[2]/form/div[3]/button"))
          .click();
        ...
        Thread.sleep(2000);
        driver.findElement(By.id("Leave_System")).click();
        
        Thread.sleep(500); //used to stop the function to wait to load the next page 
        
        try {
          assertEquals(driver.findElement(By.id("Leave_System")).getText(), "LEAVE SYSTEM");
